...
import com.flowz.introtooralanguage.display.OraLangNumbersFragment.Companion.AUDIO_REQUEST_CODE
                ...
                dialog.setOnShowListener {
                    dialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener {
                        ...
                        if (recordButtonClicked == false) {
                            ...
                            Toast.makeText(this.context, "Fetch Audio Button clicked", Toast.LENGTH_LONG).show()
                            ...
                            if (!engText.text.isNullOrBlank() && !oraText.text.isNullOrBlank()) {
                                ...
                                Toast.makeText(
                                    this.context, "strings gotten $engWordEntered $oraWordEntered", Toast.LENGTH_LONG).show()

                                oraAdapter.addOraNumber(OraLangNums(engWordEntered, oraWordEntered, null, chosenAudio))

                                Toast.makeText(this.context, "New details saved" + chosenAudio.toString(), Toast.LENGTH_LONG).show()
                                dialog.dismiss()
